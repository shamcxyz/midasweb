...
import FeaturesImage from "@/public/images/midasflow.png";

export default function Features() {
  return (
    <section className="relative bg-[#FFF5F2]">
      <div
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.pink.200/.25),transparent)1] md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-gradient-to-r before:from-transparent before:to-black/30 after:h-px after:w-8 after:bg-gradient-to-l after:from-transparent after:to-black/30">
              <span className="inline-flex text-black/80">
                Advanced Controls
              </span>
            </div>
            <h2 className="pb-4 font-nacelle text-3xl font-semibold text-black md:text-4xl">
              Built for any business teams
            </h2>
            <p className="text-lg text-black/60">
              Submit, manage, and track reimbursements requests
            </p>
          </div>
